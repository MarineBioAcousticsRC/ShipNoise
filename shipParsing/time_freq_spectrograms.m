...
for iDir = 1:length(dirList)
    ...
    for iFile = 1:nFiles
        ...
        [uTimeSteps,ia,ic] = unique(timeSteps,'stable');
        range1 = range1(ia);
        ...
        interpedTime = min(uTimeSteps):(1/(24*60)):max(uTimeSteps);
        interpedRange = interp1(uTimeSteps,range1,hdr.start.dnum+(t/(60*24*60)));
