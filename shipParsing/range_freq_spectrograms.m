...
outDir = 'J:\ShippingCINMS_data'; % where the files will save. I didn't replicate
...
tfList = importdata('J:\ShippingCINMS_data\CINMS_TFs.csv');
...
for iDir = 1:length(dirList)
    ...
    for iFile = 1:nFiles
        ...
        timesToSample = interp1(range1(1:cpaIdx),timeSteps(1:cpaIdx),myDistsApproach);
