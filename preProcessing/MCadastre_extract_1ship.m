...
fclose all;
fList = dir('E:\Downloads\AIS_zone11\AIS_ASCII_by_UTM_Month\2016\AIS_2016_09_Zone11.csv ');
for iFile = 1:size(fList,1)
    saveName = fullfile(fList(iFile).folder,strrep(fList(iFile).name,'.csv','_Tecumseh.mat'));
    ...
    while ~feof(fileID)
        ...
        if contains(myFields{1},'311056900')
