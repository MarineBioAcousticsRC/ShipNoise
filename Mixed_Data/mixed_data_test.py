...
import prepare_data_gen_mixed_test as pd
import numpy as np 
...
#
#        This is using the time spectrograms, month, length, average SOG, draught, and ship type
#        But I changed the MLP model slightly adding an extra hidden layer
...
model = Model(inputs=mlp.input, outputs=comb_output)
