...
#
#        This is using the time spectrograms, month, length, and temp
...
#        
#        Ran for 88 Epochs:
#        loss: 14.7371 - mean_squared_error: 92511.4017 - val_loss: 16.3190 - val_mean_squared_error: 112862.3931
#   
...
model.summary()
tensorboard = TensorBoard(log_dir = "/logs/mixed_data_2/")
