...
import data_gen_mixed_noise as pd
import numpy as np 
...
#tensorboard --logdir=D:\scripts\ML_Attempts\logs\Mixed_Data_Noise --host localhost --port 8088
...
model.summary()
tensorboard = TensorBoard(log_dir = 'D:\\scripts\\ML_Attempts\\logs\\Mixed_Data_Noise\\mixed_data_{}'.format(num))
...
dc.write_data(csv_data,"D:\scripts\ML_Attempts\CSV_Files\Mixed_Data_Noise.csv")
