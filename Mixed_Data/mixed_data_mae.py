...
model.compile(loss='mae', optimizer=adam,metrics=["mean_absolute_percentage_error",coeff_determination])
...
csv_data = [num,
            ...
            pd.conv(mixed.history['loss'][-1]),
            pd.conv(mixed.history['val_loss'][-1]),
            mixed.history['mean_absolute_percentage_error'][-1]*conv,
            mixed.history['val_mean_absolute_percentage_error'][-1]*conv,
