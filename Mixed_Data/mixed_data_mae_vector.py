...
model = Model(inputs=[mlp.input, cnn.input], outputs=[out_0,out_100,out_200])
...
model.compile(loss=euclidean_distance_loss, optimizer=adam,metrics={'Speed_0': [conv_mae_0,r_2,RMSE_0],
...
model.save('D:\\scripts\\ML_Attempts\\Saved_Models\\Ship_Noise_Mixed_Data_{}'.format(num), save_format='tf')
#--------------------------------------DATA COLLECTION--------------------------------------------------------------------------
