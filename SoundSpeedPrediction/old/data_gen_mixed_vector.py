    ...
    if mode=='train':
        ...
        while True:
            ...
            for b in range(batch_size):
                ...
                # special_append(feats,ship.month,'month')
                ...
                for speed in ship.sound_speed: #normalize and add all soundspeeds
                    speeds.append(speed/g_max.sound_speed)
                    
                label_batch.append(speeds) #normalize and get soundspeed
