...
import pickle
import os
from Find_Avg_Values import Avg_Values,Find_Avg
import sys, os
    ...
    if mode=='train':
        ...
        while True:
            ...
            for b in range(batch_size):
                ...
                label_batch.append((ship.sound_speed-g_avg.sound_speed)/g_avg.sound_speed_dev)#/1500) #normalize and add soundspeed
