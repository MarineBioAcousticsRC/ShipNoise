...
def clear():
    print ("\x1b[2J")
#determines colors for printing based on trend of data
def det_color(list,mode):
    #case where list is short eg epoch 0
    if len(list) < 2:
       color = '\033[37m'
       return color
    #case where numbers should be trending down
    if mode == 1:
        if list[-1] > [-2]:
            color = '\033[31m'
            return color
    ...
    #case where numbers should be trending up
    if mode == 0:
        if list[-1] > list[-2]:
            color = '\033[31m'
            return color
...
class PrintCallback(Callback):
  ...
  def on_epoch_end(self, epoch, logs=None):
    ...
    # self.speed_0_loss.append(logs['val_Speed_0_loss'])
    # self.speed_100_loss.append(logs['val_Speed_100_loss'])
    # self.speed_200_loss.append(logs['val_Speed_200_loss'])
    
    # self.speed_0_mae.append(logs['val_Speed_0_conv_mae_0'])
    # self.speed_100_mae.append(logs['val_Speed_100_conv_mae_100'])
    # self.speed_200_mae.append(logs['val_Speed_200_conv_mae_200'])
    
    # self.speed_0_rmse.append(logs['val_Speed_0_RMSE_0'])
    # self.speed_100_rmse.append(logs['val_Speed_100_RMSE_100'])
    # self.speed_200_rmse.append(logs['val_Speed_200_RMSE_200'])
    
    # self.speed_0_r2.append(logs['val_Speed_0_r_2'])
    # self.speed_100_r2.append(logs['val_Speed_100_r_2'])
    # self.speed_200_r2.append(logs['val_Speed_200_r_2'])
    
    # c1 = det_color(self.loss,0)
    
    # c2 = det_color(self.speed_0_loss,0)
    # c3 = det_color(self.speed_100_loss,0)
    # c4 = det_color(self.speed_200_loss,0)
    
    # c5 = det_color(self.speed_0_mae,0)
    # c6 = det_color(self.speed_100_mae,0)
    # c7 = det_color(self.speed_200_mae,0)
    
    # c8 = det_color(self.speed_0_rmse,0)
    # c9 = det_color(self.speed_100_rmse,0)
    # c10 = det_color(self.speed_200_rmse,0)
    
    # c11 = det_color(self.speed_0_r2,1)
    # c12 = det_color(self.speed_100_r2,1)
    # c13 = det_color(self.speed_200_r2,1)
    ...
    # print("""\t    ===========================================
            ...
            # ===========================================\n"""
            # .format(epoch, 
            # c1 + str(logs['val_loss']),
            # c2 + str(logs['val_Speed_0_loss']),c3 + str(logs['val_Speed_100_loss']),c4 + str(logs['val_Speed_200_loss']),
            # c5 + str(logs['val_Speed_0_conv_mae_0']),c6 + str(logs['val_Speed_100_conv_mae_100']),c7 + str(logs['val_Speed_200_conv_mae_200']),
            # c8 + str(logs['val_Speed_0_RMSE_0']),c9 + str(logs['val_Speed_100_RMSE_100']),c10 + str(logs['val_Speed_200_RMSE_200']),
            # c11 + str(logs['val_Speed_0_r_2']),c12 + str(logs['val_Speed_100_r_2']),c13 + str(logs['val_Speed_200_r_2'])))
    # print("""\t===========================================
        # epoch:             {}
        # -------------------------------------------
        # total_mae:        {:1.4f} 
    ...
    # print("""\t======================================================
        ...
        #             0    |   50    |   100   |   150  |   200
        #-------------------------------------------------------------
        #conv_mae: {mae0:1.4f} | {mae50:1.4f} | {mae100:1.4f} | {mae150:1.4f} | {mae200:1.4f}
        #-------------------------------------------------------------
        #MAPE:     {mape0:1.4f} | {mape50:1.4f} | {mape100:1.4f} | {mape150:1.4f} | {mape200:1.4f}
        #-------------------------------------------------------------
        #R^2:      {r0:1.4f} | {r50:1.4f} | {r100:1.4f} | {r150:1.4f} | {r200:1.4f}
        #=============================================================\n"""
    ...
    print("""\t======================================================
        ...
        .format(epoch=epoch, 
                dist=logs['val_loss'],  
                mape0=logs['val_mape_0'],
                r0=logs['val_r_2'],
                mae0=logs['val_conv_mae_0']))
